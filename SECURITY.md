...
This repository is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/kernel.git`](https://gitlab.redox-os.org/redox-os/kernel.git) carrying E-OS changes. The full
