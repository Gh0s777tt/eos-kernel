...
Fork [`https://gitlab.redox-os.org/redox-os/kernel.git`](https://gitlab.redox-os.org/redox-os/kernel.git) niosący zmiany E-OS. Gałąź, którą buduje E-OS, to **`eos-july`**,
