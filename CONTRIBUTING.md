...
This is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/kernel.git`](https://gitlab.redox-os.org/redox-os/kernel.git). Read [`CLAUDE.md`](CLAUDE.md) first — the
